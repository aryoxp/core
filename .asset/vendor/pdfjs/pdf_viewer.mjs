...
function scrollIntoView(element, spot, scrollMatches = false) {
  // console.warn(element.offset, element.offsetParent.scrollTop, spot, scrollMatches);
  // if (!scrollMatches) return;
  ...
  // console.error("X", offsetY);
  if (scrollMatches) {
    parent.scrollTop = 0;
    parent.offsetParent.scrollTop += offsetY;
    parent.offsetParent.scrollLeft += offsetX;
    // console.warn("CCC", scrollMatches, parent, parent.offsetParent.scrollTop, parent.offsetParent.scrollWidth, element, spot, offsetY);
  }// if (spot != null)
