    ...
    <div class="text-center row">
      <main class="form-signin col-md-6 col-xs-12 mx-auto" style="max-width: 300px;">
        <form id="form-sign-in" action="<?php echo $this->location('home/signIn'); ?>" method="post">
          <input type="hidden" id="redirect" name="redirect" value="<?php echo $_GET['redirect'] ?? $this->location(); ?>" />
          ...
          <div class="checkbox my-3">
            <label>
              <input type="checkbox" name="remember" value="remember-me" <?php echo isset($_COOKIE['username']) ? "checked" : ""; ?>> Remember my User ID
            </label>
          </div>
