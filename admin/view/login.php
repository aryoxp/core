<div class="app-wrapper pt-5 flex-grow-1 d-flex flex-column align-items-stretch">
  ...
  <div class="app-content pt-3 p-md-3 p-lg-4 d-flex">
    ...
    <p>Please sign-in to access this page.
      <a class="btn btn-sm btn-outline-primary border ms-2" href="<?php echo $this->location('sso', CoreView::APP); ?>">Sign In <i class="bi bi-arrow-right ms-2"></i><i class="bi bi-door-open"></i> </a>
    </p>
