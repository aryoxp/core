    ...
    <table width="100%">
      <tr class="row">
        ...
        <td class="col-6 text-end ffs">
          <h4><strong>Daftar Presensi<br>Ujian Akhir Semester</strong><br>
...
<pagebreak orientation="L" size="L" resetpagenumber="1" /> -->
  ...
  <div class="ffs">
    <div class="mt-3 fsc mb-3">
      ...
      <h4 class="mt-5"><strong>Berita Acara Ujian Akhir Semester</strong><br>
        Politeknik Kesehatan Wira Husada Nusantara
      </h4>
    </div>
    <div class="mt-5">
      <p>Berita acara ini menerangkan telah diselenggarakannya Ujian Akhir Semester (UAS) 
