<div class="container">
  <div class="row m-5">
    <div class="col">
      <h3><i class="bi bi-people-fill mx-2 text-primary"></i> Penasihat Akademik <small class="text-muted fw-light">Penugasan Penasihat Akademik</small></h3>
    </div>
  </div>
  ...
  <div class="row m-5">
    <div class="col">
      ...
      <div id="mahasiswa-selection" class="mt-1 px-2 mb-3">
        ...
        with selected: <button class="btn btn-primary px-2 py-1 bt-multi-set-pa"><i class="bi bi-people-fill"></i> <i class="bi bi-pencil"></i> Set PA</button>
      </div>
...
<div id="nip-dialog" class="shadow bg-white rounded-3 border p-4" style="display:none;">
  <form>    
    <div class="form-group mb-2">
      <label for="input-nip" class="form-label">Penasihat Akademik</label>
      <div class="">
        <select id="input-nip" name="input-nip" placeholder="" type="text" class="form-select"></select>
        <span id="input-nipHelpBlock" class="form-text mt-2 p-2 d-block">Dosen Penasihat Akademik bertugas untuk memvalidasi matakuliah yang diprogram oleh mahasiswa dalam KRS. Matakuliah terporgram dalam KRS yang tidak divalidasi oleh dosen penasihat akademik (PA) akan dibatalkan.</span>
      </div>
    </div>
  </form>
  <hr>
