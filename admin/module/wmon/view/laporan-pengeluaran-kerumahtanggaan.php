<div class="container mb-5">
  ...
  <div class="row m-5">
    <div class="col">
      <h3><i class="bi bi-book mx-2 text-primary"></i> 
        Laporan Pengeluaran Rumah Tangga <small class="text-muted fw-light">Harian</small>
      </h3>
    </div>
  </div>
  ...
  <div class="row m-5">
    <div class="col">
      <div id="list-transaksi" class="mb-3"></div>
      <div class="pagination-transaksi mb-3"></div>
