<div class="container mb-5">
  ...
  <div class="row m-5">
    <div class="col">
      <h3><i class="bi bi-cash-coin mx-2 text-primary"></i> Pengeluaran Akademi</h3>
    </div>
  </div>
  ...
  <form id="form-pembayaran" class="needs-validation" novalidate>
    <div class="row m-5">
      <div class="col">
        <h1 class="fs-4 fw-lighter my-3 text-secondary">Form Entri Pengeluaran Akademi</h1>
        <hr>
        <div class="form-group row">
          ...
          <div class="col-8">
            ...
            <span id="input-tanggalHelpBlock" class="form-text text-muted my-2 d-block">Akun kas sumber dana pengeluaran.</span>
        ...
        <div class="form-group row mb-4">
          ...
          <div class="col-8">
            <select id="input-kakundebit" name="input-kakundebit" type="text" class="form-select"
              required="required"></select>
            <span id="input-tanggalHelpBlock" class="form-text text-muted my-2 d-block">Akun biaya pengeluaran.</span>
